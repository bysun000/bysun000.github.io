...
#支付宝接口配置
$codepay_config['id'] = $conf['xq_id'];
$codepay_config['key'] = $conf['xq_key'];
...
$codepay_config['return_url'] = $codepay_config['domain'] . '/other/codepay_return.php';
$codepay_config['notify_url'] = $codepay_config['domain'] . '/other/codepay_notify.php';
$pay_id = $or;
$param = $pay_id;
if ($type <= 0) $type = 3;
